#!/usr/bin/env python
# USAGE
# rosrun face_detect  pan_tilt_tracking.py --cascade haarcascade_frontalface_default.xml
...
def obj_center(args, objX, objY, centerX, centerY):
	...
	# loop indefinitely
		...
		pub = rospy.Publisher("/usb_cam/image_raw", Image, queue_size=50)
